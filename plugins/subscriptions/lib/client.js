...
// css-text:/tmp/dsh/aidos/--home-sid-repos-dotfiles-ai--/341/plugins/shared/settings.css
...
// css-text:/tmp/dsh/aidos/--home-sid-repos-dotfiles-ai--/341/plugins/subscriptions/src/client.module.css
...
function makePanel(ctx, config) {
  return function Panel() {
    ...
    if ((goUsage === null || goUsage === void 0) && balance && !balance.error && balance.data && balance.data.ok === true && balance.data.usage) {
