...
function selectApproval(owner) {
  ...
  for (var i = 0; i < list.length; i++) {
    ...
    any = true;
    var reason = interaction.payload !== null && typeof interaction.payload === "object" ? interaction.payload.reason : void 0;
    if (isBashGuardReason(reason)) rewrite = true;
    else escalated = true;
  }
  if (!any) return null;
  return { escalated, rewrite };
}
function ComposerShadow(props) {
  ...
  return /* @__PURE__ */ import_react.default.createElement(
    "div",
    {
      ...
      "aria-hidden": true,
      "data-escalated": matched.escalated === true ? "" : void 0,
      "data-rewrite": matched.rewrite === true ? "" : void 0
    }
  );
}
