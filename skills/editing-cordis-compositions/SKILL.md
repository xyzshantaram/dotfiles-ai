...
whenToUse: The user wants to write or edit a Cordis composition, author an agent preset, add or remove a plugin row, validate that a preset mounts, or diagnose a row that mounted but contributed nothing.
tools-gated: [cordis_inspect_list, cordis_inspect_query, cordis_inspect_self]
---
