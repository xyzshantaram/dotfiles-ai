...
import { css } from "lit";
var segmented_field_styles_default = css`
    ...
    return html`
      ...
      "Use arrow keys to change values; press Alt+Down Arrow to open the time picker."
            ...
            >
              ...
              ${hasFooterSlot ? html`<div class="popup-footer"><slot name="footer"></slot></div>` : this.withNow ? html`<div class="popup-footer">
...
__decorateClass([
  property({ attribute: "with-now", type: Boolean })
